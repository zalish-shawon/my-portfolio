...
const Education = () => {
    return (
        <div className="max-w-[85%] mx-auto pt-2 pb-2" id="education">
                ...
                <div className="bg-[#2f4550]">
                    <div className="flex flex-col lg:flex-row items-center">
                        ...
                        <div >
                            ...
                            <p className="py-1 text-[22px] font-semibold text-center text-[#909AB9]"><span className="text-[#b8dbd9]">Passing Year: </span>2021</p>
                            </div>
